...
하나의 공통 이력서를 유지하면서 회사별 자기소개와 지원동기만 따로 관리할 수 있습니다. 각 이력서는 짧은 URL로 공유할 수 있고, Markdown으로 내보내 AI 도구에 붙여 넣어 피드백을 받기 쉽게 설계했습니다.
...
| `/resume/markdown` | 기본 이력서 Markdown 내보내기 |
| `/resumes/[id]` | 기업별 이력서 공개 페이지 |
| `/resumes/[id]/markdown` | 기업별 이력서 Markdown 내보내기 |
...
Markdown 내보내기 파일 상단에는 AI 피드백 요청 문구가 자동으로 포함됩니다. 이력서 내용을 AI 도구에 붙여 넣고 다음 항목을 빠르게 점검받기 위한 목적입니다.
